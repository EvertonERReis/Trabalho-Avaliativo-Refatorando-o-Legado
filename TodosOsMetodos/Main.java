                ...
                if (tarefas.isEmpty()) {
                    ...
                    try {
                        ...
                        if (indice >= 1 && indice <= tarefas.size()) {
                            ...
                            System.out.println("Detalhes atuais: " + detalhes.get(indice - 1));
                            System.out.print("Novos detalhes (ou deixe em branco para não alterar): ");
                            String novosDetalhes = scanner.nextLine();
                            if (!novosDetalhes.trim().isEmpty()) {
                                detalhes.set(indice - 1, novosDetalhes);
                            }
